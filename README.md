...
2. **Configure artifacts** - If a circuit path was provided, `.r1cs` files are copied automatically. Otherwise, copy `.r1cs` and `.wasm` files into `circuits/` and update `ceremony.config.ts`

...
Explain Caburé in 3 sentences: what it is (Groth16 Phase 2 trusted setup toolkit), what it replaces (p0tion + DefinitelySetup), and the three packages (`@defi-wonderland/cabure-crypto`, `create-cabure-ceremony`, `@defi-wonderland/cabure-cli`).
...
- **crypto/** — imports from `@defi-wonderland/cabure-crypto` (published package maintained by Lumi)
...
- Package names: `@defi-wonderland/cabure-crypto`, `create-cabure-ceremony`, `@defi-wonderland/cabure-cli` — never use `elixir-wizard`
...
- Remind them about BES-1346 (handoff walkthrough with Lumi) — they should understand `@defi-wonderland/cabure-crypto` exports before building

## 6. Questions

Ask the developer:
1. Have you done the handoff walkthrough with Lumi on `@defi-wonderland/cabure-crypto`?

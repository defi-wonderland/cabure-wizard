...
**`@defi-wonderland/cabure-crypto`** (Lumi)
...
- Generated project has three independent parts: stateless coordinator (serverless), static frontend (6-screen ceremony flow), and crypto layer (imports from `@defi-wonderland/cabure-crypto`).
- The generated code is yours — edit freely. Only the crypto layer is a dependency.

**`@defi-wonderland/cabure-cli`** (Ardy)
- Headless CLI contributor tool for VMs and servers.
- URL-based discovery: `npx @defi-wonderland/cabure-cli contribute https://ceremony.example.com`
...
3. Or contributors use `npx @defi-wonderland/cabure-cli contribute <url>` from the terminal
...
- **Notion Tech Design** — detailed technical specification for create-cabure-ceremony and @defi-wonderland/cabure-cli

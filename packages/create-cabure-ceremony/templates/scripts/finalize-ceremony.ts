...
async function main() {
  ...
  for (const circuitConfig of circuitConfigs) {
    ...
    console.log(`  Saved verification key to output/${vkeyFile}`);
  ...
  console.log(`  Transcript: output/transcript.json`);
  console.log(`  Verification keys: output/*.vkey.json`);
  console.log(`  Finalized zkeys:   output/*.final.zkey`);
